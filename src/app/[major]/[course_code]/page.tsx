									...
									<CardContent className="flex-1 space-y-4">
										...
										<div className="space-y-2">
											{Array.from({ length: 4 }, () => {
												...
												return (
													<div key={`skeleton-detail-${detailId}`} className="flex items-center gap-2">
			...
			<div className="space-y-6">
				<Card className="py-12 text-center">
					<CardContent>
						...
						>
							<FileUploadDropzone className="rounded-lg border-2 border-dashed p-8 transition-colors border-muted-foreground/25 hover:border-muted-foreground/40">
								<div className="flex flex-col items-center gap-4">
									...
									<FileUploadTrigger asChild>
										<Button variant="outline" size="sm" className="bg-mcmaster-maroon text-white">
											Choose Files
										</Button>
									</FileUploadTrigger>
								</div>
